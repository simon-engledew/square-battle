...
//                body.BodyType = BodyType.Dynamic;
//                body.SetTransform(new Vector2(random.Next(0, graphics.Viewport.TitleSafeArea.Right), random.Next(0, graphics.Viewport.TitleSafeArea.Bottom)), 0.0f);
...
//            {
//                body.Draw(graphics, ((BodyData)(body.UserData ?? Unknown)).Color);
//            }
//        }
//    }
//}
